...
try:
    ...
    try:
        ...
        AllFilesWithCountResponseCustomer = getattr(
            d361api, "AllFilesWithCountResponseCustomer", None
        )
        if AllFilesWithCountResponseCustomer is None:
            raise ImportError(
                "Could not find AllFilesWithCountResponseCustomer in d361api module"
            )
        __all__ = ["AllFilesWithCountResponseCustomer"]

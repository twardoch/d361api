...
try:
    from d361api.d361api.bulk_create_article_response_customer import (
    ...
    try:
        ...
        BulkCreateArticleResponseCustomer = getattr(
            d361api, "BulkCreateArticleResponseCustomer", None
        )
        if BulkCreateArticleResponseCustomer is None:
            raise ImportError(
                "Could not find BulkCreateArticleResponseCustomer in d361api module"
            )
        __all__ = ["BulkCreateArticleResponseCustomer"]

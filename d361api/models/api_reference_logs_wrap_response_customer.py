...
try:
    ...
    try:
        ...
        ApiReferenceLogsWrapResponseCustomer = getattr(
            d361api, "ApiReferenceLogsWrapResponseCustomer", None
        )
        if ApiReferenceLogsWrapResponseCustomer is None:
            raise ImportError(
                "Could not find ApiReferenceLogsWrapResponseCustomer in d361api module"
            )
        __all__ = ["ApiReferenceLogsWrapResponseCustomer"]

...
try:
    ...
    try:
        ...
        ArticleSimpleDataCustomerResponse = getattr(
            d361api, "ArticleSimpleDataCustomerResponse", None
        )
        if ArticleSimpleDataCustomerResponse is None:
            raise ImportError(
                "Could not find ArticleSimpleDataCustomerResponse in d361api module"
            )
        __all__ = ["ArticleSimpleDataCustomerResponse"]

...
try:
    from d361api.d361api.bulk_update_category_content_response import (
    ...
    try:
        ...
        BulkUpdateCategoryContentResponse = getattr(
            d361api, "BulkUpdateCategoryContentResponse", None
        )
        if BulkUpdateCategoryContentResponse is None:
            raise ImportError(
                "Could not find BulkUpdateCategoryContentResponse in d361api module"
            )
        __all__ = ["BulkUpdateCategoryContentResponse"]

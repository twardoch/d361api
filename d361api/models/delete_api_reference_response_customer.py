...
try:
    from d361api.d361api.delete_api_reference_response_customer import (
    ...
    try:
        ...
        DeleteApiReferenceResponseCustomer = getattr(
            d361api, "DeleteApiReferenceResponseCustomer", None
        )
        if DeleteApiReferenceResponseCustomer is None:
            raise ImportError(
                "Could not find DeleteApiReferenceResponseCustomer in d361api module"
            )
        __all__ = ["DeleteApiReferenceResponseCustomer"]

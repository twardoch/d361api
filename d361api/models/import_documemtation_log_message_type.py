...
try:
    from d361api.d361api.import_documemtation_log_message_type import (
    ...
    try:
        ...
        ImportDocumemtationLogMessageType = getattr(
            d361api, "ImportDocumemtationLogMessageType", None
        )
        if ImportDocumemtationLogMessageType is None:
            raise ImportError(
                "Could not find ImportDocumemtationLogMessageType in d361api module"
            )
        __all__ = ["ImportDocumemtationLogMessageType"]

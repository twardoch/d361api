...
try:
    ...
    try:
        ...
        MediaFolderMetaDataResponseCustomer = getattr(
            d361api, "MediaFolderMetaDataResponseCustomer", None
        )
        if MediaFolderMetaDataResponseCustomer is None:
            raise ImportError(
                "Could not find MediaFolderMetaDataResponseCustomer in d361api module"
            )
        __all__ = ["MediaFolderMetaDataResponseCustomer"]

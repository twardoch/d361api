...
try:
    from d361api.d361api.article_version_info_customer_response import (
    ...
    try:
        ...
        ArticleVersionInfoCustomerResponse = getattr(
            d361api, "ArticleVersionInfoCustomerResponse", None
        )
        if ArticleVersionInfoCustomerResponse is None:
            raise ImportError(
                "Could not find ArticleVersionInfoCustomerResponse in d361api module"
            )
        __all__ = ["ArticleVersionInfoCustomerResponse"]

...
try:
    ...
    try:
        ...
        DeletedandStarredMetaDataCustomer = getattr(
            d361api, "DeletedandStarredMetaDataCustomer", None
        )
        if DeletedandStarredMetaDataCustomer is None:
            raise ImportError(
                "Could not find DeletedandStarredMetaDataCustomer in d361api module"
            )
        __all__ = ["DeletedandStarredMetaDataCustomer"]

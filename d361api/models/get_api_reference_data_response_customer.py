...
try:
    from d361api.d361api.get_api_reference_data_response_customer import (
    ...
    try:
        ...
        GetApiReferenceDataResponseCustomer = getattr(
            d361api, "GetApiReferenceDataResponseCustomer", None
        )
        if GetApiReferenceDataResponseCustomer is None:
            raise ImportError(
                "Could not find GetApiReferenceDataResponseCustomer in d361api module"
            )
        __all__ = ["GetApiReferenceDataResponseCustomer"]

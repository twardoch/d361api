...
try:
    ...
    try:
        ...
        MediaFileAndTagsMetaDataCustomer = getattr(
            d361api, "MediaFileAndTagsMetaDataCustomer", None
        )
        if MediaFileAndTagsMetaDataCustomer is None:
            raise ImportError("Could not find MediaFileAndTagsMetaDataCustomer in d361api module")
        __all__ = ["MediaFileAndTagsMetaDataCustomer"]

...
try:
    from d361api.d361api.update_media_folder_request_customer import (
    ...
    try:
        ...
        UpdateMediaFolderRequestCustomer = getattr(
            d361api, "UpdateMediaFolderRequestCustomer", None
        )
        if UpdateMediaFolderRequestCustomer is None:
            raise ImportError("Could not find UpdateMediaFolderRequestCustomer in d361api module")
        __all__ = ["UpdateMediaFolderRequestCustomer"]

...
try:
    from d361api.d361api.export_documentation_status_response import (
    ...
    try:
        ...
        ExportDocumentationStatusResponse = getattr(
            d361api, "ExportDocumentationStatusResponse", None
        )
        if ExportDocumentationStatusResponse is None:
            raise ImportError(
                "Could not find ExportDocumentationStatusResponse in d361api module"
            )
        __all__ = ["ExportDocumentationStatusResponse"]

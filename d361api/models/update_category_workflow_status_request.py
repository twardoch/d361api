...
try:
    from d361api.d361api.update_category_workflow_status_request import (
    ...
    try:
        ...
        UpdateCategoryWorkflowStatusRequest = getattr(
            d361api, "UpdateCategoryWorkflowStatusRequest", None
        )
        if UpdateCategoryWorkflowStatusRequest is None:
            raise ImportError(
                "Could not find UpdateCategoryWorkflowStatusRequest in d361api module"
            )
        __all__ = ["UpdateCategoryWorkflowStatusRequest"]

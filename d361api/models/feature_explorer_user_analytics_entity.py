...
try:
    ...
    try:
        ...
        FeatureExplorerUserAnalyticsEntity = getattr(
            d361api, "FeatureExplorerUserAnalyticsEntity", None
        )
        if FeatureExplorerUserAnalyticsEntity is None:
            raise ImportError(
                "Could not find FeatureExplorerUserAnalyticsEntity in d361api module"
            )
        __all__ = ["FeatureExplorerUserAnalyticsEntity"]

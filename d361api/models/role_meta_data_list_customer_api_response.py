...
try:
    ...
    try:
        ...
        RoleMetaDataListCustomerApiResponse = getattr(
            d361api, "RoleMetaDataListCustomerApiResponse", None
        )
        if RoleMetaDataListCustomerApiResponse is None:
            raise ImportError(
                "Could not find RoleMetaDataListCustomerApiResponse in d361api module"
            )
        __all__ = ["RoleMetaDataListCustomerApiResponse"]

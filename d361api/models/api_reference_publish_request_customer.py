...
try:
    from d361api.d361api.api_reference_publish_request_customer import (
    ...
    try:
        ...
        ApiReferencePublishRequestCustomer = getattr(
            d361api, "ApiReferencePublishRequestCustomer", None
        )
        if ApiReferencePublishRequestCustomer is None:
            raise ImportError(
                "Could not find ApiReferencePublishRequestCustomer in d361api module"
            )
        __all__ = ["ApiReferencePublishRequestCustomer"]

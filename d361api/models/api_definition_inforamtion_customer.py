...
try:
    from d361api.d361api.api_definition_inforamtion_customer import (
    ...
    try:
        ...
        ApiDefinitionInforamtionCustomer = getattr(
            d361api, "ApiDefinitionInforamtionCustomer", None
        )
        if ApiDefinitionInforamtionCustomer is None:
            raise ImportError("Could not find ApiDefinitionInforamtionCustomer in d361api module")
        __all__ = ["ApiDefinitionInforamtionCustomer"]

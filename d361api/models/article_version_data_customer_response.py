...
try:
    from d361api.d361api.article_version_data_customer_response import (
    ...
    try:
        ...
        ArticleVersionDataCustomerResponse = getattr(
            d361api, "ArticleVersionDataCustomerResponse", None
        )
        if ArticleVersionDataCustomerResponse is None:
            raise ImportError(
                "Could not find ArticleVersionDataCustomerResponse in d361api module"
            )
        __all__ = ["ArticleVersionDataCustomerResponse"]

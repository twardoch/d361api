...
try:
    from d361api.d361api.bulk_delete_category_version_response import (
    ...
    try:
        ...
        BulkDeleteCategoryVersionResponse = getattr(
            d361api, "BulkDeleteCategoryVersionResponse", None
        )
        if BulkDeleteCategoryVersionResponse is None:
            raise ImportError(
                "Could not find BulkDeleteCategoryVersionResponse in d361api module"
            )
        __all__ = ["BulkDeleteCategoryVersionResponse"]

...
try:
    ...
    try:
        ...
        UpdateCategoryContentCustomerRequest = getattr(
            d361api, "UpdateCategoryContentCustomerRequest", None
        )
        if UpdateCategoryContentCustomerRequest is None:
            raise ImportError(
                "Could not find UpdateCategoryContentCustomerRequest in d361api module"
            )
        __all__ = ["UpdateCategoryContentCustomerRequest"]

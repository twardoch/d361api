...
from d361api.models.workflow_status_customer import WorkflowStatusCustomer
...
class GetWorkflowStatusResponse(BaseModel):
    ...
    data: Optional[List[WorkflowStatusCustomer]] = Field(
        default=None,
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": [WorkflowStatusCustomer.from_dict(_item) for _item in obj["data"]]

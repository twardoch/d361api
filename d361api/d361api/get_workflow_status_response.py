...
class GetWorkflowStatusResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[WorkflowStatusCustomer]] = Field(default=None, description="Contains the list of workflow statuses configured for the current project. Each object represents a single workflow status definition.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [WorkflowStatusCustomer.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,

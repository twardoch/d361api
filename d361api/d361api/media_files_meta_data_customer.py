...
class MediaFilesMetaDataCustomer(BaseModel):
    ...
    file_type: StrictStr | None = Field(default=None, description="The file tyoe")
    file_url: StrictStr | None = Field(default=None, description="The file URL")
    updated_on: datetime | None = Field(default=None, description="The date file was modified")
    ...
    tags: list[TagsMetaDataCustomer] | None = Field(default=None, description="The tags associated with file")

...
class Title(BaseModel):
    ...
    value: Optional[StrictStr] = Field(
        default=None, description="Markup text with occurrences highlighted."
    )
    match_level: Optional[StrictStr] = Field(
        default=None,
    ...
    matched_words: Optional[List[StrictStr]] = Field(
        default=None, description="List of words from the query that matched the object."
    )

...
class AddMediaFileResponseCustomer(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[MediaFileMetaDataCustomer]] = Field(default=None, description="Bulk response of file details")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [MediaFileMetaDataCustomer.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,

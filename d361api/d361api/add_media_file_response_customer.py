...
from d361api.models.media_file_meta_data_customer import \
...
class AddMediaFileResponseCustomer(BaseModel):
    ...
    """
    data: list[MediaFileMetaDataCustomer] | None = Field(default=None, description="Bulk response of file details")

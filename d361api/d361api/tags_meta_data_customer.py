...
class TagsMetaDataCustomer(BaseModel):
    """
    TagsMetaDataCustomer
    """  # noqa: E501

    id: Optional[StrictStr] = Field(default=None, description="The tag ID")
    tag_name: Optional[StrictStr] = Field(default=None, description="The tag name")
    __properties: ClassVar[List[str]] = ["id", "tag_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"id": obj.get("id"), "tag_name": obj.get("tag_name")})
        return _obj

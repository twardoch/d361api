...
class MediaFolderMetaDataResponseCustomer(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[MediaFolderMetaDataCustomer] = Field(default=None, description="Media folder response meta data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": MediaFolderMetaDataCustomer.from_dict(obj["data"]) if obj.get("data") is not None else None,

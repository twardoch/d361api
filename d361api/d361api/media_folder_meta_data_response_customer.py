...
from d361api.models.media_folder_meta_data_customer import MediaFolderMetaDataCustomer


class MediaFolderMetaDataResponseCustomer(BaseModel):
    """
    MediaFolderMetaDataResponseCustomer
    """  # noqa: E501

    data: Optional[MediaFolderMetaDataCustomer] = Field(
        default=None, description="Media folder response meta data"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": MediaFolderMetaDataCustomer.from_dict(obj["data"])

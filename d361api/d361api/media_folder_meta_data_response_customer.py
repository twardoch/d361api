...
from d361api.models.media_folder_meta_data_customer import \
...
class MediaFolderMetaDataResponseCustomer(BaseModel):
    ...
    """
    data: MediaFolderMetaDataCustomer | None = Field(default=None, description="Media folder response meta data")

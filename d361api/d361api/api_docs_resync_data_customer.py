...
class ApiDocsResyncDataCustomer(BaseModel):
    ...
    categories_created: StrictInt | None = Field(default=None, description="Total categories created")
    articles_created: StrictInt | None = Field(default=None, description="Total articles created")

...
class ApiDocsResyncDataCustomer(BaseModel):
    ...
    errors: Optional[List[ApiErrorAndWarningsData]] = Field(
        default=None, description="Error log response"
    )
    alerts: Optional[List[ApiErrorAndWarningsData]] = Field(
        default=None, description="Alerts log response"
    )
    categories_created: Optional[StrictInt] = Field(
        default=None, description="Total categories created"
    )
    articles_created: Optional[StrictInt] = Field(
        default=None, description="Total articles created"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "errors": [ApiErrorAndWarningsData.from_dict(_item) for _item in obj["errors"]]
                if obj.get("errors") is not None
                else None,
                "alerts": [ApiErrorAndWarningsData.from_dict(_item) for _item in obj["alerts"]]

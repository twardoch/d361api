...
class ReaderGroupCustomerV2(BaseModel):
    ...
    """
    reader_group_id: StrictStr | None = Field(default=None, description="The ID of the reader group.")
    title: StrictStr | None = Field(default=None, description="The name of the reader group.")
    description: StrictStr | None = Field(default=None, description="Description of the reader group.")
    associated_readers: list[StrictStr] | None = Field(default=None, description="List of reader IDs to be associated with this reader group.")
    associated_invited_sso_users: list[StrictStr] | None = Field(default=None, description="List of reader invitation IDs. Applicable only for SSO readers.")
    access_scope: AccessScopeCustomerV2 | None = Field(default=None, description="Access scope of this reader group.")

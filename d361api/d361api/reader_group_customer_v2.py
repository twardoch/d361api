...
class ReaderGroupCustomerV2(BaseModel):
    ...
    reader_group_id: Optional[StrictStr] = Field(
        default=None, description="The ID of the reader group."
    )
    ...
    associated_readers: Optional[List[StrictStr]] = Field(
        default=None, description="List of reader IDs to be associated with this reader group."
    )
    associated_invited_sso_users: Optional[List[StrictStr]] = Field(
        default=None, description="List of reader invitation IDs. Applicable only for SSO readers."
    )
    access_scope: Optional[AccessScopeCustomerV2] = Field(
        default=None, description="Access scope of this reader group."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "access_scope": AccessScopeCustomerV2.from_dict(obj["access_scope"])

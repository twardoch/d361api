...
class BulkDeleteCategoryVersionResponse(BaseModel):
    ...
    data: StrictStr | None = Field(default=None, description="The list of deleted category versions")
    ...
    __properties: ClassVar[list[str]] = ["category_id", "data", "extension_data", "success", "errors", "warnings", "information"]

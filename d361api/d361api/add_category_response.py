...
class AddCategoryResponse(BaseModel):
    ...
    AddCategoryResponse
    """ # noqa: E501
    data: Optional[CategorySimpleData] = Field(default=None, description="added category response data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CategorySimpleData.from_dict(obj["data"]) if obj.get("data") is not None else None,

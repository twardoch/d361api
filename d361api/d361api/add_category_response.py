...
from d361api.models.category_simple_data import CategorySimpleData
...
class AddCategoryResponse(BaseModel):
    ...
    data: Optional[CategorySimpleData] = Field(
        default=None, description="added category response data"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": CategorySimpleData.from_dict(obj["data"])

...
class BulkUnpublishArticleRequest(BaseModel):
    ...
    articles: List[BulkUnpublishArticle] = Field(
    ...
    unpublish_message: Optional[StrictStr] = Field(
        default=None, description="The unpublish message of the article"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "articles": [BulkUnpublishArticle.from_dict(_item) for _item in obj["articles"]]

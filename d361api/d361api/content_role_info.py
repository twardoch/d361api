...
class ContentRoleInfo(BaseModel):
    ...
    access_scope_level: Optional[AccessScopeLevel] = Field(
        default=None,
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.guide_category_access_info is None
            and "guide_category_access_info" in self.model_fields_set
        ):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "version_access_info": VersionAccessInfo.from_dict(obj["version_access_info"])
                if obj.get("version_access_info") is not None
                else None,
                "language_access_info": LanguageAccessInfo.from_dict(obj["language_access_info"])
                if obj.get("language_access_info") is not None
                else None,
                "category_access_info": CategoryAccessInfo.from_dict(obj["category_access_info"])
                if obj.get("category_access_info") is not None
                else None,
                "article_access_info": ArticleAccessInfo.from_dict(obj["article_access_info"])
                if obj.get("article_access_info") is not None
                else None,
                "access_scope_level": obj.get("access_scope_level"),
                "guide_access_info": GuideAccessInfo.from_dict(obj["guide_access_info"])
                if obj.get("guide_access_info") is not None
                else None,
                "guide_category_access_info": CategoryAccessInfo.from_dict(
                    obj["guide_category_access_info"]
                )
                if obj.get("guide_category_access_info") is not None
                else None,

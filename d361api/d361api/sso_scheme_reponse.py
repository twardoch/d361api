...
from d361api.models.sso_scheme_details import SSOSchemeDetails


class SSOSchemeReponse(BaseModel):
    """
    SSOSchemeReponse
    """  # noqa: E501

    schemes: Optional[List[SSOSchemeDetails]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "schemes": [SSOSchemeDetails.from_dict(_item) for _item in obj["schemes"]]
                if obj.get("schemes") is not None
                else None,

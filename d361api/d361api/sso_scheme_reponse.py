...
class SSOSchemeReponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["schemes", "extension_data", "success", "errors", "warnings", "information"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "schemes": [SSOSchemeDetails.from_dict(_item) for _item in obj["schemes"]] if obj.get("schemes") is not None else None,

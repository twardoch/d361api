...
from d361api.models.delete_api_definition_customer import \
...
class DeleteApiReferenceResponseCustomer(BaseModel):
    ...
    """
    data: list[DeleteApiDefinitionCustomer] | None = Field(default=None, description="Response data of the deletion")

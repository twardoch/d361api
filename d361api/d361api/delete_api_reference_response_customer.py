...
class DeleteApiReferenceResponseCustomer(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[DeleteApiDefinitionCustomer]] = Field(default=None, description="Response data of the deletion")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [DeleteApiDefinitionCustomer.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,

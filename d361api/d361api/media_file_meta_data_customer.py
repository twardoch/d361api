...
class MediaFileMetaDataCustomer(BaseModel):
    ...
    updated_by: StrictStr | None = Field(default=None, description="The ID of the user who uploaded the file")
    media_folder_id: StrictStr | None = Field(default=None, description="The parent Folder ID")

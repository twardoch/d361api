...
class ExportDocumentationStatusResponse(BaseModel):
    """
    ExportDocumentationStatusResponse
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Current status of the export and it can be either one of these status 'Initiated/InProgress/Completed/Error'")
    download_url: Optional[StrictStr] = Field(default=None, description="Exported .zip file URL. The download URL will be available when the export status is completed")
    ...
    __properties: ClassVar[List[str]] = ["status", "download_url", "extension_data", "success", "errors", "warnings", "information"]

...
class ExportDocumentationStatusResponse(BaseModel):
    ...
    """
    status: StrictStr | None = Field(default=None, description="Current status of the export and it can be either one of these status 'Initiated/InProgress/Completed/Error'")
    download_url: StrictStr | None = Field(default=None, description="Exported .zip file URL. The download URL will be available when the export status is completed")

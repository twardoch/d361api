...
class ArticleSettingCustomer(BaseModel):
    """
    ...
    __properties: ClassVar[list[str]] = ["slug", "seo_title", "description", "allow_comments", "show_table_of_contents", "featured_image_url", "tags", "status_indicator", "status_indicator_expiry_date", "exclude_from_search", "exclude_from_ai_search", "related_articles", "is_acknowledgement_enabled"]

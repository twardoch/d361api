...
class BaseInformation(BaseModel):
    ...
    BaseInformation
    """
    extension_data: dict[str, Any] | None = Field(default=None, description="Extention data for customer Api response information")
    description: StrictStr | None = Field(default=None, description="status description for customer Api response information")

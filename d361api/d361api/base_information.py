...
class BaseInformation(BaseModel):
    ...
    BaseInformation
    """ # noqa: E501
    extension_data: Optional[Dict[str, Any]] = Field(default=None, description="Extention data for customer Api response information")
    description: Optional[StrictStr] = Field(default=None, description="status description for customer Api response information")

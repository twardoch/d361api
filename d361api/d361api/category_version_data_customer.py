...
class CategoryVersionDataCustomer(BaseModel):
    ...
    html_content: Optional[StrictStr] = Field(
        default=None, description="The HTML content of the category"
    )
    block_content: Optional[StrictStr] = Field(
        default=None, description="The HTML content of the category (Block editor)"
    )
    ...
    project_version_id: Optional[StrictStr] = Field(
        default=None, description="Existing project version ID"
    )
    version_number: Optional[StrictInt] = Field(
        default=None, description="Category Version Number"
    )
    public_version: Optional[StrictInt] = Field(
        default=None, description="The ID of the project version where this category is located"
    )
    latest_version: Optional[StrictInt] = Field(
        default=None, description="The latest version number of this category"
    )
    ...
    hidden: Optional[StrictBool] = Field(
        default=None, description="Indicates if the category is visible on the site"
    )
    status: Optional[ArticleStatusCustomer] = Field(
        default=None, description="The status of the category: 0 - Draft,  3 - Published"
    )
    ...
    created_by: Optional[StrictStr] = Field(
        default=None, description="The ID of the user that created the category"
    )
    authors: Optional[List[UserProfileCustomer]] = Field(
        default=None, description="The list of authors that contributed to this category"
    )
    created_at: Optional[datetime] = Field(
        default=None, description="The date the category was created"
    )
    modified_at: Optional[datetime] = Field(
        default=None, description="The date the category was last modified"
    )

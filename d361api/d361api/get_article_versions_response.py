...
from d361api.models.article_simple_version_customer import \
...
class GetArticleVersionsResponse(BaseModel):
    ...
    """
    data: list[ArticleSimpleVersionCustomer] | None = Field(default=None, description="Article version response data")

...
class UpdateCategoryWorkflowStatusRequest(BaseModel):
    ...
    lang_code: Annotated[str, Field(min_length=1, strict=True)] = Field(
    ...
    category_ids: List[StrictStr] = Field(
    ...
    workflow_status_info: CategoryWorkflowStatus = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "workflow_status_info": CategoryWorkflowStatus.from_dict(
                    obj["workflow_status_info"]
                )
                if obj.get("workflow_status_info") is not None
                else None,
            }
        )
        return _obj

...
class CategorySettingsCustomer(BaseModel):
    ...
    seo_title: StrictStr | None = Field(default=None, description="SEO title of the category")
    description: StrictStr | None = Field(default=None, description="SEO description of the category")
    allow_comments: StrictBool | None = Field(default=None, description="Allow comments for category")
    show_table_of_contents: StrictBool | None = Field(default=None, description="`True` - Table of Contents will be enabled   `False` - Table of Contents will be disabled")
    featured_image_url: StrictStr | None = Field(default=None, description="URL of the featured image")
    tags: list[StrictStr] | None = Field(default=None, description="List of Tags associated to the category")
    status_indicator: ArticleStatusIndicator | None = Field(default=None, description="Category status in the knowledge base. 0 - None; 1 - New; 2 - Updated; 3 - Custom")
    ...
    exclude_from_search: StrictBool | None = Field(default=None, description="**true** - The caetgory will not appear in search results in the knowledge base  **false** - The category will appear in search results in the knowledge base")
    exclude_from_ai_search: StrictBool | None = Field(default=None, description="**true** - The AI search assistant will not fetch information from this page category;   **false** - The AI search assistant will not exclude this page category while fetching information")
    related_articles: list[RelatedArticleData] | None = Field(default=None, description="The list of related article IDs to show in the knowledge base")
    content_type: ArticleContentType | None = Field(default=None, description="0 - Markdown content; 1 - HTML content")

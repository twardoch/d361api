...
class RoleMetaDataListCustomerApiResponse(BaseModel):
    ...
    """ # noqa: E501
    result: Optional[List[RoleMetaData]] = Field(default=None, description="Customer API response data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": [RoleMetaData.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,

...
from d361api.models.role_meta_data import RoleMetaData


class RoleMetaDataListCustomerApiResponse(BaseModel):
    """
    RoleMetaDataListCustomerApiResponse
    """  # noqa: E501

    result: Optional[List[RoleMetaData]] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "result": [RoleMetaData.from_dict(_item) for _item in obj["result"]]

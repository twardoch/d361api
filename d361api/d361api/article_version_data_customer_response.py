...
class ArticleVersionDataCustomerResponse(BaseModel):
    ...
    html_content: Optional[StrictStr] = Field(
        default=None,
        description=" If the article editor is **WYSIWYG (HTML)**, then the content will be present in this property.   **Note**: Markdown editor will also have HTML content (read-only).",
    )
    category_id: Optional[StrictStr] = Field(
        default=None, description="The ID of the article's parent category"
    )
    project_version_id: Optional[StrictStr] = Field(
        default=None, description="The ID of the project version where the article is located"
    )
    version_number: Optional[StrictInt] = Field(
        default=None, description="The currently fetched version number of the article"
    )
    public_version: Optional[StrictInt] = Field(
        default=None, description="The currently published version number of the article"
    )
    latest_version: Optional[StrictInt] = Field(
        default=None, description="The latest version number of the article"
    )
    enable_rtl: Optional[StrictBool] = Field(
        default=None,
    ...
    hidden: Optional[StrictBool] = Field(
        default=None, description="`False` indicates that the article is visible on the site"
    )
    status: Optional[ArticleStatusCustomer] = Field(
        default=None, description="The status of the article: 0 - Draft, 3 - Published"
    )
    order: Optional[StrictInt] = Field(
        default=None, description="The position inside the parent category"
    )
    created_by: Optional[StrictStr] = Field(
        default=None, description="The ID of the team account who created the article"
    )
    authors: Optional[List[UserDetailsCustomer]] = Field(
        default=None, description="The list of contributors in the article"
    )
    created_at: Optional[datetime] = Field(
        default=None, description="The date on which the article was created"
    )
    modified_at: Optional[datetime] = Field(
        default=None, description="The date on which the article was last modified"
    )
    slug: Optional[StrictStr] = Field(default=None, description="The slug of the article")
    is_fall_back_content: Optional[StrictBool] = Field(
        default=None,
        description="`True` indicates that the article content is a fallback of the default language content",
    )
    description: Optional[StrictStr] = Field(
        default=None, description="The description of the article"
    )
    category_type: Optional[CategoryType] = Field(
        default=None, description="0 - Folder, 1 - Page, 2 - Index"
    )
    content_type: Optional[ArticleContentType] = Field(
        default=None, description="0 - Markdown; 1 - WYSIWYG(HTML); 2 - Advanced WYSIWYG"
    )
    is_shared_article: Optional[StrictBool] = Field(
        default=None, description="`True` indicates that the article is shared"
    )
    translation_option: Optional[LanguageTranslationOption] = Field(
        default=None, description="The Translation status of the article"
    )
    url: Optional[StrictStr] = Field(default=None, description="Url of the article")
    current_workflow_status_id: Optional[StrictStr] = Field(
        default=None, description="Current Workflow status of the article"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.current_workflow_status_id is None
            and "current_workflow_status_id" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "authors": [UserDetailsCustomer.from_dict(_item) for _item in obj["authors"]]
                if obj.get("authors") is not None
                else None,

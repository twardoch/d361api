...
class GetCategoryVersionsResponse(BaseModel):
    ...
    versions: Optional[List[CategorySimpleVersionCustomer]] = Field(
        default=None, description="get category data by version"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "versions": [
                    CategorySimpleVersionCustomer.from_dict(_item) for _item in obj["versions"]
                ]

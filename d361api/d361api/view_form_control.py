...
class ViewFormControl(BaseModel):
    ...
    ViewFormControl
    """ # noqa: E501
    property_key: Optional[StrictStr] = None
    is_children: Optional[StrictInt] = None
    view_type: Optional[StrictStr] = None
    element_name: Optional[StrictStr] = None
    is_children_root: Optional[StrictBool] = None
    element_type: Optional[StrictStr] = None
    inverted_value: Optional[StrictBool] = None

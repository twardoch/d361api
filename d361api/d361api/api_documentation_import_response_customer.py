...
from d361api.models.api_docs_import_data_customer import ApiDocsImportDataCustomer
...
class ApiDocumentationImportResponseCustomer(BaseModel):
    """
    ApiDocumentationImportResponseCustomer
    """  # noqa: E501

    data: Optional[ApiDocsImportDataCustomer] = Field(
        default=None, description="Import response data"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": ApiDocsImportDataCustomer.from_dict(obj["data"])

...
class FormEditableProperties(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.edit_component_style_properties is None
            and "edit_component_style_properties" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.edit_component_properties is None
            and "edit_component_properties" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "label": obj.get("label"),
                "value": obj.get("value"),
                "view_form_control": ViewFormControl.from_dict(obj["view_form_control"])
                if obj.get("view_form_control") is not None
                else None,
                "editable_properties": FormEditableProperties.from_dict(obj["editable_properties"])
                if obj.get("editable_properties") is not None
                else None,
                "element_guid": obj.get("element_guid"),
                "children": [FormEditableProperties.from_dict(_item) for _item in obj["children"]]

...
class VersionAccessInfo(BaseModel):
    """
    VersionAccessInfo
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["version_name", "version_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"version_name": obj.get("version_name"), "version_id": obj.get("version_id")}
        )
        return _obj

...
from d361api.models.need_translation_article_data import \
...
class GetArticleNotTranslatedResponse(BaseModel):
    ...
    """
    data: list[NeedTranslationArticleData] | None = Field(default=None, description="Article need to be translated")

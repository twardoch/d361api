...
from d361api.models.need_translation_article_data import NeedTranslationArticleData


class GetArticleNotTranslatedResponse(BaseModel):
    """
    GetArticleNotTranslatedResponse
    """  # noqa: E501

    data: Optional[List[NeedTranslationArticleData]] = Field(
        default=None, description="Article need to be translated"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": [NeedTranslationArticleData.from_dict(_item) for _item in obj["data"]]

...
from d361api.models.article_setting_customer_response import \
...
class UpdateArticleSettingsResponseCustomer(BaseModel):
    ...
    """
    data: ArticleSettingCustomerResponse | None = Field(default=None, description="update article settings")

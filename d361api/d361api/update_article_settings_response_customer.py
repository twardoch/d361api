...
class UpdateArticleSettingsResponseCustomer(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[ArticleSettingCustomerResponse] = Field(default=None, description="update article settings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ArticleSettingCustomerResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,

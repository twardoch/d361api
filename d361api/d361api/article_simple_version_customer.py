...
class ArticleSimpleVersionCustomer(BaseModel):
    ...
    version_number: Optional[StrictInt] = Field(
        default=None, description="The version number of the article"
    )
    created_by: Optional[StrictStr] = Field(default=None, description="Author name")
    created_at: Optional[datetime] = Field(
        default=None, description="The date the article version was created"
    )
    modified_at: Optional[datetime] = Field(
        default=None, description="The last time the article version was modified"
    )
    base_version: Optional[StrictInt] = Field(
        default=None, description="The version number from which this article version is derived"
    )

...
class ArticleSimpleVersionCustomer(BaseModel):
    ...
    """
    version_number: StrictInt | None = Field(default=None, description="The version number of the article")
    created_by: StrictStr | None = Field(default=None, description="Author name")
    created_at: datetime | None = Field(default=None, description="The date the article version was created")
    modified_at: datetime | None = Field(default=None, description="The last time the article version was modified")
    base_version: StrictInt | None = Field(default=None, description="The version number from which this article version is derived")
    status: ArticleStatusCustomer | None = Field(default=None, description="The status of the article: 0 - Draft, 3 - Published")
    profile_url: StrictStr | None = Field(default=None, description="Author profile image")

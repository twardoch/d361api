...
from d361api.models.complete_user_info_customer import CompleteUserInfoCustomer


class CompleteUserInfoCustomerCustomerApiResponse(BaseModel):
    """
    CompleteUserInfoCustomerCustomerApiResponse
    """  # noqa: E501

    result: Optional[CompleteUserInfoCustomer] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "result": CompleteUserInfoCustomer.from_dict(obj["result"])

    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.feature_explorer_user_analytics:
            _dict["feature_explorer_user_analytics"] = (
                self.feature_explorer_user_analytics.to_dict()
            )
        ...
        # and model_fields_set contains the field
        if (
            self.feature_explorer_user_analytics is None
            and "feature_explorer_user_analytics" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "feature_explorer_user_analytics": FeatureExplorerUserAnalyticsEntity.from_dict(
                    obj["feature_explorer_user_analytics"]
                )
                if obj.get("feature_explorer_user_analytics") is not None
                else None,
            }
        )
        return _obj

...
class CompleteUserInfoCustomer(BaseModel):
    ...
    profile_logo_url: Optional[StrictStr] = Field(
        default=None, description="Profile image URL of the user"
    )
    last_login_at: Optional[datetime] = Field(
        default=None, description="Last login date of the user"
    )
    portal_role: Optional[RoleSummaryCustomer] = Field(
        default=None, description="The name of the portal role"
    )
    content_roles: Optional[List[ContentRoleSummaryCustomer]] = Field(
        default=None, description="The name of content role"
    )
    associated_groups: Optional[List[GroupInfo]] = Field(
        default=None, description="THe group associated with the team account"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "portal_role": RoleSummaryCustomer.from_dict(obj["portal_role"])
                if obj.get("portal_role") is not None
                else None,
                "content_roles": [
                    ContentRoleSummaryCustomer.from_dict(_item) for _item in obj["content_roles"]
                ]
                if obj.get("content_roles") is not None
                else None,
                "associated_groups": [
                    GroupInfo.from_dict(_item) for _item in obj["associated_groups"]
                ]
                if obj.get("associated_groups") is not None
                else None,
            }
        )
        return _obj

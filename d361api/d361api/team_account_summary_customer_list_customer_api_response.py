...
from d361api.models.team_account_summary_customer import TeamAccountSummaryCustomer


class TeamAccountSummaryCustomerListCustomerApiResponse(BaseModel):
    """
    TeamAccountSummaryCustomerListCustomerApiResponse
    """  # noqa: E501

    result: Optional[List[TeamAccountSummaryCustomer]] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "result": [TeamAccountSummaryCustomer.from_dict(_item) for _item in obj["result"]]

...
from d361api.models.team_account_summary_customer import \
...
class TeamAccountSummaryCustomerListCustomerApiResponse(BaseModel):
    ...
    """
    result: list[TeamAccountSummaryCustomer] | None = Field(default=None, description="Customer API response data")

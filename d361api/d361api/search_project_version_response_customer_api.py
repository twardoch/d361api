...
from d361api.models.article_matched_data import ArticleMatchedData
...
class SearchProjectVersionResponseCustomerApi(BaseModel):
    """
    SearchProjectVersionResponseCustomerApi
    """  # noqa: E501

    data: Optional[ArticleMatchedData] = None
    extension_data: Optional[Dict[str, Any]] = Field(
        default=None, description="Extention data for customer API response"
    )
    success: Optional[StrictBool] = Field(
        default=None, description="Status indication for customer API response"
    )
    errors: Optional[List[BaseError]] = Field(
        default=None, description="Errors in the customer API response"
    )
    warnings: Optional[List[BaseWarning]] = Field(
        default=None, description="Warnings in the customer API response"
    )
    information: Optional[List[BaseInformation]] = Field(
        default=None, description="Information passed by the customer API response"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": ArticleMatchedData.from_dict(obj["data"])

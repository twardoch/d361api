...
class ApiDocumentationResyncResponseCustomer(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[ApiDocsResyncDataCustomer] = Field(default=None, description="Resync response data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ApiDocsResyncDataCustomer.from_dict(obj["data"]) if obj.get("data") is not None else None,

...
from d361api.models.api_docs_resync_data_customer import ApiDocsResyncDataCustomer
...
class ApiDocumentationResyncResponseCustomer(BaseModel):
    """
    ApiDocumentationResyncResponseCustomer
    """  # noqa: E501

    data: Optional[ApiDocsResyncDataCustomer] = Field(
        default=None, description="Resync response data"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": ApiDocsResyncDataCustomer.from_dict(obj["data"])

...
class ForkArticleVersionResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[ArticleSimpleVersionCustomer] = Field(default=None, description="forked article data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ArticleSimpleVersionCustomer.from_dict(obj["data"]) if obj.get("data") is not None else None,

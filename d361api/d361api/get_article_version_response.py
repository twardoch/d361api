...
from d361api.models.article_version_info_customer_response import (
...
class GetArticleVersionResponse(BaseModel):
    """
    GetArticleVersionResponse
    """  # noqa: E501

    data: Optional[ArticleVersionInfoCustomerResponse] = Field(
        default=None, description="Get article data"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": ArticleVersionInfoCustomerResponse.from_dict(obj["data"])

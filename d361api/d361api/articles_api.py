...
class ArticlesApi:
    ...
    @validate_call
    async def v2_articles_article_id_lang_code_publish_delete(
        self,
        article_id: Annotated[StrictStr, Field(description="The ID of the article")],
        lang_code: Annotated[StrictStr, Field(description="Language code of the article")],
        unpublish_article_request: Optional[UnpublishArticleRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param lang_code: Language code of the article (required)
        :type lang_code: str
        :param unpublish_article_request:
        :type unpublish_article_request: UnpublishArticleRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._v2_articles_article_id_lang_code_publish_delete_serialize(
            article_id=article_id,
            lang_code=lang_code,
            unpublish_article_request=unpublish_article_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    async def v2_articles_article_id_lang_code_publish_delete_with_http_info(
        self,
        article_id: Annotated[StrictStr, Field(description="The ID of the article")],
        lang_code: Annotated[StrictStr, Field(description="Language code of the article")],
        unpublish_article_request: Optional[UnpublishArticleRequest] = None,
    ...
    @validate_call
    async def v2_articles_article_id_lang_code_publish_delete_without_preload_content(
        self,
        article_id: Annotated[StrictStr, Field(description="The ID of the article")],
        lang_code: Annotated[StrictStr, Field(description="Language code of the article")],
        unpublish_article_request: Optional[UnpublishArticleRequest] = None,
    ...
    def _v2_articles_article_id_lang_code_publish_delete_serialize(
        self,
        article_id,
        lang_code,
        ...
        # process the form parameters
        # process the body parameter
        if unpublish_article_request is not None:
            _body_params = unpublish_article_request
    ...
    async def v2_articles_article_id_update_description_put(
        ...
        """  # noqa: E501
        warnings.warn(
            "PUT /v2/Articles/{articleId}/updateDescription is deprecated.", DeprecationWarning
        )
    ...
    @validate_call
    async def v2_articles_bulkpublish_lang_code_delete(
        self,
        lang_code: Annotated[StrictStr, Field(description="Language code of the article")],
        bulk_unpublish_article_request: Optional[BulkUnpublishArticleRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param lang_code: Language code of the article (required)
        :type lang_code: str
        :param bulk_unpublish_article_request:
        :type bulk_unpublish_article_request: BulkUnpublishArticleRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._v2_articles_bulkpublish_lang_code_delete_serialize(
            lang_code=lang_code,
            bulk_unpublish_article_request=bulk_unpublish_article_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "BulkUnpublishArticleResponse",
            "400": "CustomerApiBaseResponse",
        }
        response_data = await self.api_client.call_api(*_param, _request_timeout=_request_timeout)
        await response_data.read()
    ...
    @validate_call
    async def v2_articles_bulkpublish_lang_code_delete_with_http_info(
        self,
        lang_code: Annotated[StrictStr, Field(description="Language code of the article")],
        bulk_unpublish_article_request: Optional[BulkUnpublishArticleRequest] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BulkUnpublishArticleResponse]:
        """Unpublishes multiple articles
    ...
    @validate_call
    async def v2_articles_bulkpublish_lang_code_delete_without_preload_content(
        self,
        lang_code: Annotated[StrictStr, Field(description="Language code of the article")],
        bulk_unpublish_article_request: Optional[BulkUnpublishArticleRequest] = None,
        _request_timeout: Union[
    ...
    def _v2_articles_bulkpublish_lang_code_delete_serialize(
        self,
        lang_code,
        bulk_unpublish_article_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if bulk_unpublish_article_request is not None:
            _body_params = bulk_unpublish_article_request
    ...
    @validate_call
    async def v2_articles_update_workflow_post(
        self,
        article_update_workflow_request: Optional[ArticleUpdateWorkflowRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param article_update_workflow_request:
        :type article_update_workflow_request: ArticleUpdateWorkflowRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._v2_articles_update_workflow_post_serialize(
            article_update_workflow_request=article_update_workflow_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    async def v2_articles_update_workflow_post_with_http_info(
        self,
        article_update_workflow_request: Optional[ArticleUpdateWorkflowRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def v2_articles_update_workflow_post_without_preload_content(
        self,
        article_update_workflow_request: Optional[ArticleUpdateWorkflowRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _v2_articles_update_workflow_post_serialize(
        self,
        article_update_workflow_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if article_update_workflow_request is not None:
            _body_params = article_update_workflow_request
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/v2/Articles/update-workflow",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

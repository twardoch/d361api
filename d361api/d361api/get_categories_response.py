...
from d361api.models.category_data_customer import CategoryDataCustomer
...
class GetCategoriesResponse(BaseModel):
    ...
    data: Optional[List[CategoryDataCustomer]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": [CategoryDataCustomer.from_dict(_item) for _item in obj["data"]]

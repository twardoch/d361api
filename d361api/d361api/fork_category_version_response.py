...
from d361api.models.category_simple_version_customer import CategorySimpleVersionCustomer


class ForkCategoryVersionResponse(BaseModel):
    """
    ForkCategoryVersionResponse
    """  # noqa: E501

    data: Optional[CategorySimpleVersionCustomer] = Field(
        default=None, description="category response forked data"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": CategorySimpleVersionCustomer.from_dict(obj["data"])

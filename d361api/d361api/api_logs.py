...
class ApiLogs(BaseModel):
    ...
    ApiLogs
    """
    message: StrictStr | None = Field(default=None, description="Descriptive message represent the problem occur")
    pointer: StrictStr | None = Field(default=None, description="Path where the problem occur")

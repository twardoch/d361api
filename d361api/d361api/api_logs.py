...
class ApiLogs(BaseModel):
    ...
    message: Optional[StrictStr] = Field(
        default=None, description="Descriptive message represent the problem occur"
    )
    pointer: Optional[StrictStr] = Field(default=None, description="Path where the problem occur")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"message": obj.get("message"), "pointer": obj.get("pointer")})
        return _obj

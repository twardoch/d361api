...
from d361api.models.category_version_data_customer import CategoryVersionDataCustomer


class UpdateCategoryContentCustomerResponse(BaseModel):
    """
    UpdateCategoryContentCustomerResponse
    """  # noqa: E501

    data: Optional[CategoryVersionDataCustomer] = Field(
        default=None, description="category version data"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": CategoryVersionDataCustomer.from_dict(obj["data"])

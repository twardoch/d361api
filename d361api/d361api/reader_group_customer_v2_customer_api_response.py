...
class ReaderGroupCustomerV2CustomerApiResponse(BaseModel):
    ...
    """ # noqa: E501
    result: Optional[ReaderGroupCustomerV2] = Field(default=None, description="Customer API response data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": ReaderGroupCustomerV2.from_dict(obj["result"]) if obj.get("result") is not None else None,

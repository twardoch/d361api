...
class CategorySimpleVersionCustomer(BaseModel):
    ...
    base_version: Optional[StrictInt] = Field(
        default=None, description="The base version of the currently fetched category page"
    )
    ...
    profile_url: Optional[StrictStr] = Field(
        default=None, description="The URL of team account's profile image"
    )

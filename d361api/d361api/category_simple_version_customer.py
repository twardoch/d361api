...
class CategorySimpleVersionCustomer(BaseModel):
    ...
    base_version: StrictInt | None = Field(default=None, description="The base version of the currently fetched category page")
    status: ArticleStatusCustomer | None = Field(default=None, description="The status of the article: 0 - Draft, 3 - Published")
    profile_url: StrictStr | None = Field(default=None, description="The URL of team account's profile image")

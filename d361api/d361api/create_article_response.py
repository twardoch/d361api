...
class CreateArticleResponse(BaseModel):
    ...
    """
    data: ArticleSimpleDataCustomer | None = Field(default=None, description="Create article response data")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "data": ArticleSimpleDataCustomer.from_dict(obj["data"]) if obj.get("data") is not None else None,

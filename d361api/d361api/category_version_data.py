...
class CategoryVersionData(BaseModel):
    ...
    content: Optional[StrictStr] = Field(
        default=None, description="Category page Markdown content"
    )
    html_content: Optional[StrictStr] = Field(
        default=None, description="Category page WYSIWYG(HTML) content"
    )
    block_content: Optional[StrictStr] = Field(
        default=None, description="Category page Advanced WYSIWYG content"
    )
    parent_category_id: Optional[StrictStr] = Field(default=None, description="Parent category ID")
    project_document_version_id: Optional[StrictStr] = Field(
        default=None, description="Project document version ID"
    )
    version_number: Optional[StrictInt] = Field(
        default=None, description="The currently fetched version number of this category page"
    )
    ...
    latest_version: Optional[StrictInt] = Field(
        default=None, description="The latest version number(revision) of this  category page."
    )
    ...
    hidden: Optional[StrictBool] = Field(
        default=None, description="Indicates if the category page is visible on the site"
    )
    ...
    created_by: Optional[StrictStr] = Field(
        default=None, description="The ID of the user that created the category page"
    )
    authors: Optional[List[UserProfileCustomer]] = Field(
        default=None, description="The list of authors that contributed to this category page"
    )
    created_at: Optional[datetime] = Field(
        default=None, description="The date the category page was created"
    )
    modified_at: Optional[datetime] = Field(
        default=None, description="The date the category page was last modified"
    )
    ...
    stale_status: Optional[StaleStatus] = Field(
        default=None,
        description="Fresh - Category page is up-to-date  Stale -  Category page requires review",
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # and model_fields_set contains the field
        if (
            self.project_document_version_id is None
            and "project_document_version_id" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "authors": [UserProfileCustomer.from_dict(_item) for _item in obj["authors"]]
                ...
                "stale_status": StaleStatus.from_dict(obj["stale_status"])
                if obj.get("stale_status") is not None
                else None,

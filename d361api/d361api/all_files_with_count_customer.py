...
class AllFilesWithCountCustomer(BaseModel):
    ...
    all_files: Optional[List[DeletedandStarredMetaDataCustomer]] = Field(
        default=None, description="Search file items from drive"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "all_files": [
                    DeletedandStarredMetaDataCustomer.from_dict(_item)
                    for _item in obj["all_files"]
                ]
                if obj.get("all_files") is not None
                else None,
                "count": obj.get("count"),
            }
        )

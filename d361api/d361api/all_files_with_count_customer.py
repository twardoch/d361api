...
from d361api.models.deletedand_starred_meta_data_customer import \
...
class AllFilesWithCountCustomer(BaseModel):
    ...
    """
    all_files: list[DeletedandStarredMetaDataCustomer] | None = Field(default=None, description="Search file items from drive")
    count: StrictInt | None = Field(default=None, description="Total file count")

...
class GetDriveFilesInArticleDataCustomer(BaseModel):
    ...
    file_urls: Optional[List[StrictStr]] = Field(default=None, description="List of media files in the article")
    ...
    __properties: ClassVar[List[str]] = ["article_id", "file_urls", "extension_data", "success", "errors", "warnings", "information"]

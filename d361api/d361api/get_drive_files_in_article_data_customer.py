...
class GetDriveFilesInArticleDataCustomer(BaseModel):
    ...
    """
    article_id: StrictStr | None = Field(default=None, description="Id of the Article")
    file_urls: list[StrictStr] | None = Field(default=None, description="List of media files in the article")

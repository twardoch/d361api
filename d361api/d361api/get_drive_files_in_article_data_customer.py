...
class GetDriveFilesInArticleDataCustomer(BaseModel):
    """
    GetDriveFilesInArticleDataCustomer
    """  # noqa: E501

    article_id: Optional[StrictStr] = Field(default=None, description="Id of the Article")
    file_urls: Optional[List[StrictStr]] = Field(
        default=None, description="List of media files in the article"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if file_urls (nullable) is None
        # and model_fields_set contains the field
        if self.file_urls is None and "file_urls" in self.model_fields_set:
            _dict["file_urls"] = None

...
class GetMediaFolderResponseCustomer(BaseModel):
    """
    GetMediaFolderResponseCustomer
    """  # noqa: E501

    data: Optional[List[MediaFoldersDataCustomer]] = Field(
        default=None, description="Dive folders meta"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": [MediaFoldersDataCustomer.from_dict(_item) for _item in obj["data"]]

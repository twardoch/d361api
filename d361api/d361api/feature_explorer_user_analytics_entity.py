        ...
        _obj = cls.model_validate(
            {
                ...
                "trophy_status": TrophyStatus.from_dict(obj["trophy_status"])
                if obj.get("trophy_status") is not None
                else None,
                ...
                "features": [FeatureAnalytics.from_dict(_item) for _item in obj["features"]]

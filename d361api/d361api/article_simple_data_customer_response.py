...
class ArticleSimpleDataCustomerResponse(BaseModel):
    ...
    latest_version: Optional[StrictInt] = Field(
        default=None, description="The latest version number of this article"
    )
    language_code: Optional[StrictStr] = Field(
        default=None, description="The default language code"
    )
    ...
    order: Optional[StrictInt] = Field(
        default=None, description="The position of the article inside the parent category"
    )

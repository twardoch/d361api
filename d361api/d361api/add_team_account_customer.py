...
class AddTeamAccountCustomer(BaseModel):
    ...
    first_name: StrictStr | None = Field(default=None, description="First name of the team account")
    last_name: StrictStr | None = Field(default=None, description="Last name of the team account")
    ...
    is_sso_user: StrictBool | None = Field(default=None, description="Set this to true, if you are adding an SSO user")
    ...
    skip_sso_invitation_email: StrictBool | None = Field(default=None, description="Set this to true, if you would like to avoid sending an invitation email to the newly added team account.  This property is applicable only when adding a SSO user.")
    ...
    associated_groups: list[StrictStr] | None = Field(default=None, description="A list of group ids to which the team account has to be added. Please refer /teams/groups endpoint to get the available groups.")

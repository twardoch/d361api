...
from d361api.models.export_type import ExportType
...
class ExportDocumentationRequest(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.filter_by_article_modified_at is None
            and "filter_by_article_modified_at" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "selected_languages": [
                    LanguageMeta.from_dict(_item) for _item in obj["selected_languages"]
                ]
                if obj.get("selected_languages") is not None
                else None,
                "selected_categories": [
                    CategoryMeta.from_dict(_item) for _item in obj["selected_categories"]
                ]
                if obj.get("selected_categories") is not None
                else None,
                "exclude_media_files": obj.get("exclude_media_files"),
                "filter_by_article_modified_at": DateRange.from_dict(
                    obj["filter_by_article_modified_at"]
                )
                if obj.get("filter_by_article_modified_at") is not None
                else None,

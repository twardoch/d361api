...
class PublicAPIAIFeedbackRequest(BaseModel):
    ...
    is_liked: Optional[StrictBool] = Field(
        default=None,
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.feedback_provider_email is None
            and "feedback_provider_email" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.additional_feedback_info is None
            and "additional_feedback_info" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "additional_feedback_info": AIAdditionalFeedbackInfo.from_dict(
                    obj["additional_feedback_info"]
                )
                if obj.get("additional_feedback_info") is not None
                else None,

...
class MediaFolderMetaDataCustomer(BaseModel):
    ...
    updated_on: Optional[datetime] = Field(
        default=None, description="The date the file was modified"
    )
    ...
    updated_by: Optional[StrictStr] = Field(
        default=None, description="The ID of the user who uploaded the folder"
    )
    parent_media_folder_id: Optional[StrictStr] = Field(
        default=None, description="The parent folder ID"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.parent_media_folder_id is None
            and "parent_media_folder_id" in self.model_fields_set
        ):

...
class AccessScopeCustomerV2(BaseModel):
    ...
    access_level: Optional[AccessScopeLevel] = Field(
        default=None,
        description="The access level of the reader group. 0-None, 1-Category, 2-Version, 3-Project, 4-Language",
    )
    categories: Optional[List[CategorySummaryCustomerV2]] = Field(
        default=None, description="List of category scope objects."
    )
    project_versions: Optional[List[StrictStr]] = Field(
        default=None, description="List of project version IDs the reader has access to."
    )
    languages: Optional[List[LanguageSummaryCustomer]] = Field(
        default=None, description="List of language scope objects."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "categories": [
                    CategorySummaryCustomerV2.from_dict(_item) for _item in obj["categories"]
                ]
                if obj.get("categories") is not None
                else None,
                "project_versions": obj.get("project_versions"),
                "languages": [
                    LanguageSummaryCustomer.from_dict(_item) for _item in obj["languages"]
                ]

...
class BulkDeleteArticleVersionResonse(BaseModel):
    """
    BulkDeleteArticleVersionResonse
    """  # noqa: E501

    article_id: Optional[StrictStr] = Field(default=None, description="IDs of the articles")
    data: Optional[StrictStr] = Field(default=None, description="Response article data")

...
class GetMediaFolderWithIdCustomer(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[MediaFolderViewMetaDataCustomer] = Field(default=None, description="Drive folder meta data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": MediaFolderViewMetaDataCustomer.from_dict(obj["data"]) if obj.get("data") is not None else None,

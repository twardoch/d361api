...
from d361api.models.media_folder_view_meta_data_customer import \
...
class GetMediaFolderWithIdCustomer(BaseModel):
    ...
    """
    data: MediaFolderViewMetaDataCustomer | None = Field(default=None, description="Drive folder meta data")

...
class TeamAccountGroupSummaryCustomer(BaseModel):
    ...
    group_id: Optional[StrictStr] = Field(
        default=None, description="The ID of the team account group."
    )
    title: Optional[StrictStr] = Field(
        default=None, description="The name of the team account group."
    )
    description: Optional[StrictStr] = Field(
        default=None, description="Description of the team account group."
    )

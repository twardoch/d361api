...
class MediaFileAndTagsMetaDataResponseCustomer(BaseModel):
    ...
    data: Optional[MediaFileAndTagsMetaDataCustomer] = Field(
        default=None, description="File response with tag data"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": MediaFileAndTagsMetaDataCustomer.from_dict(obj["data"])

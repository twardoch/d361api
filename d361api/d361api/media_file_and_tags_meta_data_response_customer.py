...
from d361api.models.media_file_and_tags_meta_data_customer import \
...
class MediaFileAndTagsMetaDataResponseCustomer(BaseModel):
    ...
    """
    data: MediaFileAndTagsMetaDataCustomer | None = Field(default=None, description="File response with tag data")

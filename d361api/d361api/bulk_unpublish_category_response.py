...
from d361api.models.bulk_category_result import BulkCategoryResult


class BulkUnpublishCategoryResponse(BaseModel):
    """
    BulkUnpublishCategoryResponse
    """  # noqa: E501

    data: Optional[List[BulkCategoryResult]] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": [BulkCategoryResult.from_dict(_item) for _item in obj["data"]]

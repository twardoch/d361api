...
class BulkUnpublishCategoryResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[BulkCategoryResult]] = Field(default=None, description="Bulk unpublish article response data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [BulkCategoryResult.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,

...
class ApiErrorAndWarningsData(BaseModel):
    ...
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Descriptive message of the problem")
    pointer: Optional[StrictStr] = Field(default=None, description="Path where the problem occures")

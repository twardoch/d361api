...
class BulkArticleResultCustomer(BaseModel):
    ...
    article_id: Optional[StrictStr] = Field(
        default=None, description="Article ID that has updated"
    )
    success: Optional[StrictBool] = Field(
        default=None, description="Indicates if articles creation was successful"
    )
    details: Optional[StrictStr] = Field(
        default=None, description="Additional information about articles creation status"
    )

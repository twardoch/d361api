...
from d361api.models.article_version_data_customer_response import ArticleVersionDataCustomerResponse
...
class GetArticleResponseCustomer(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[ArticleVersionDataCustomerResponse] = Field(default=None, description="Article data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ArticleVersionDataCustomerResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,

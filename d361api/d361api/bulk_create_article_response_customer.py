...
from d361api.models.bulk_article_result_customer import \
...
class BulkCreateArticleResponseCustomer(BaseModel):
    ...
    """
    data: list[BulkArticleResultCustomer] | None = Field(default=None, description="Bulk article create response")

...
class AIAssistiveSearch(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.feature_explorer_status is None
            and "feature_explorer_status" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "reference_articles": [
                    VectorSearchReferenceArticles.from_dict(_item)
                    for _item in obj["reference_articles"]
                ]
                if obj.get("reference_articles") is not None
                else None,
                ...
                "context": BaseResponseContext.from_dict(obj["context"])
                ...
                "feature_explorer_status": FeatureExplorerStatus.from_dict(
                    obj["feature_explorer_status"]
                )
                if obj.get("feature_explorer_status") is not None
                else None,
                "custom_page_element": UIElement.from_dict(obj["custom_page_element"])
                if obj.get("custom_page_element") is not None
                else None,
            }
        )
        return _obj

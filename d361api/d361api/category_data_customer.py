...
class CategoryDataCustomer(BaseModel):
    ...
    order: Optional[StrictInt] = Field(
        default=None, description="The position the category inside the parent category"
    )
    parent_category_id: Optional[StrictStr] = Field(
        default=None, description="The ID of the parent category ( null if top-level )"
    )
    ...
    articles: Optional[List[ArticleSimpleDataCustomer]] = Field(
        default=None, description="The list of articles attached to this category"
    )
    child_categories: Optional[List[CategoryDataCustomer]] = Field(
        default=None, description="The list of categories attached to this category"
    )
    icon: Optional[StrictStr] = Field(
        default=None, description="Unicode representation of the icon or image URL"
    )
    slug: Optional[StrictStr] = Field(default=None, description="The slug of the category")
    language_code: Optional[StrictStr] = Field(
        default=None, description="Language code of the category"
    )
    ...
    modified_at: Optional[datetime] = Field(
        default=None, description="Category modified date time"
    )
    status: Optional[ArticleStatusCustomer] = Field(
        default=None, description="The status of the page type category: 0 - Draft, 3 - Published"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "articles": [
                    ArticleSimpleDataCustomer.from_dict(_item) for _item in obj["articles"]
                ]
                if obj.get("articles") is not None
                else None,
                "child_categories": [
                    CategoryDataCustomer.from_dict(_item) for _item in obj["child_categories"]
                ]
                if obj.get("child_categories") is not None
                else None,
                "icon": obj.get("icon"),
                "slug": obj.get("slug"),

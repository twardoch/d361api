...
from d361api.models.article_simple_data_customer_response import ArticleSimpleDataCustomerResponse
...
class GetArticlesResponseCustomer(BaseModel):
    """
    GetArticlesResponseCustomer
    """  # noqa: E501

    data: Optional[List[ArticleSimpleDataCustomerResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": [
                    ArticleSimpleDataCustomerResponse.from_dict(_item) for _item in obj["data"]
                ]

...
class GetLogsDetailsResponseCustomer(BaseModel):
    ...
    """
    api_reference_errors: list[ApiLogs] | None = Field(default=None, description="Error log response")
    api_reference_alerts: list[ApiLogs] | None = Field(default=None, description="Alerts log response")

...
class GetLogsDetailsResponseCustomer(BaseModel):
    ...
    api_reference_errors: Optional[List[ApiLogs]] = Field(
        default=None, description="Error log response"
    )
    api_reference_alerts: Optional[List[ApiLogs]] = Field(
        default=None, description="Alerts log response"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "api_reference_errors": [
                    ApiLogs.from_dict(_item) for _item in obj["api_reference_errors"]
                ]
                if obj.get("api_reference_errors") is not None
                else None,
                "api_reference_alerts": [
                    ApiLogs.from_dict(_item) for _item in obj["api_reference_alerts"]
                ]
                if obj.get("api_reference_alerts") is not None
                else None,

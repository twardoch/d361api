...
class MediaFoldersDataCustomer(BaseModel):
    ...
    """
    id: StrictStr | None = Field(default=None, description="This is the folder Id")
    title: StrictStr | None = Field(default=None, description="This is the folder title")
    parent_folder_id: StrictStr | None = Field(default=None, description="The parent folder ID")
    sub_folders: list[MediaFoldersDataCustomer] | None = Field(default=None, description="The sub folders in the parent")
    items_count: StrictInt | None = Field(default=None, description="The items in the folder")

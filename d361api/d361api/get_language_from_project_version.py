...
from d361api.models.project_language import ProjectLanguage


class GetLanguageFromProjectVersion(BaseModel):
    """
    GetLanguageFromProjectVersion
    """  # noqa: E501

    data: Optional[List[ProjectLanguage]] = Field(
        default=None, description="All Language data in a poject"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": [ProjectLanguage.from_dict(_item) for _item in obj["data"]]

...
from d361api.models.import_api_log import ImportAPILog


class ImportDocumentationStatusResponse(BaseModel):
    """
    ImportDocumentationStatusResponse
    """  # noqa: E501

    import_documentation_log: Optional[ImportAPILog] = Field(
        default=None, description="Details about the import"
    )
    ...
    extension_data: Optional[Dict[str, Any]] = Field(
        default=None, description="Extension data for customer API response"
    )
    ...
    errors: Optional[List[BaseError]] = Field(
        default=None,
    ...
    warnings: Optional[List[BaseWarning]] = Field(
        default=None,
    ...
    information: Optional[List[BaseInformation]] = Field(
        default=None,
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of import_documentation_log
        if self.import_documentation_log:
            _dict["import_documentation_log"] = self.import_documentation_log.to_dict()
        ...
        # set to None if import_documentation_log (nullable) is None
        # and model_fields_set contains the field
        if (
            self.import_documentation_log is None
            and "import_documentation_log" in self.model_fields_set
        ):
            _dict["import_documentation_log"] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "import_documentation_log": ImportAPILog.from_dict(obj["import_documentation_log"])
                if obj.get("import_documentation_log") is not None
                else None,
                "status": obj.get("status"),
                "extension_data": obj.get("extension_data"),
                "success": obj.get("success"),
                "errors": [BaseError.from_dict(_item) for _item in obj["errors"]]
                if obj.get("errors") is not None
                else None,
                "warnings": [BaseWarning.from_dict(_item) for _item in obj["warnings"]]
                if obj.get("warnings") is not None
                else None,
                "information": [BaseInformation.from_dict(_item) for _item in obj["information"]]

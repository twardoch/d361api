...
class ImportDocumentationStatusResponse(BaseModel):
    ...
    """ # noqa: E501
    import_documentation_log: Optional[ImportAPILog] = Field(default=None, description="Details about the import")
    status: Optional[StrictStr] = Field(default=None, description="Current status of the import and it can be either one of these statuses 'Queued/InProgress/Completed/Error'")
    ...
    __properties: ClassVar[List[str]] = ["import_documentation_log", "status", "extension_data", "success", "errors", "warnings", "information"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.import_documentation_log is None and "import_documentation_log" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "import_documentation_log": ImportAPILog.from_dict(obj["import_documentation_log"]) if obj.get("import_documentation_log") is not None else None,

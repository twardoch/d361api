...
class ImportDocumentationStatusResponse(BaseModel):
    ...
    """
    import_documentation_log: ImportAPILog | None = Field(default=None, description="Details about the import")
    status: StrictStr | None = Field(default=None, description="Current status of the import and it can be either one of these statuses 'Queued/InProgress/Completed/Error'")

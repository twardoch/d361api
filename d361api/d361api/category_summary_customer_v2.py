...
class CategorySummaryCustomerV2(BaseModel):
    ...
    category_id: Optional[StrictStr] = Field(
        default=None, description="The category ID to which the user should be given access."
    )
    project_version_id: Optional[StrictStr] = Field(
        default=None, description="The project version ID to which the category belongs."
    )
    language_code: Optional[StrictStr] = Field(
        default=None, description="The language to which the user should be given access."
    )

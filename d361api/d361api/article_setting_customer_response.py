...
class ArticleSettingCustomerResponse(BaseModel):
    ...
    allow_comments: Optional[StrictBool] = Field(default=None, description="`True` indicates that comments are allowed in the article")
    show_table_of_contents: Optional[StrictBool] = Field(default=None, description="`True` indicates that Table of Contents are shown in the article")
    featured_image_url: Optional[StrictStr] = Field(default=None, description="URL of the featured image")
    tags: Optional[List[StrictStr]] = Field(default=None, description="List of tags associated to the article")
    status_indicator: Optional[ArticleStatusIndicator] = Field(default=None, description="The status of the article: 0 - None, 1 - New, 2 - Updated, 3 - Custom")
    ...
    exclude_from_search: Optional[StrictBool] = Field(default=None, description="`True` indicates that the article will not appear in the Knowledge base search results")
    exclude_from_ai_search: Optional[StrictBool] = None
    related_articles: Optional[List[RelatedArticleData]] = Field(default=None, description="List of related articles associated to the article")

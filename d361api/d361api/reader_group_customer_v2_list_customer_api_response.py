...
from d361api.models.reader_group_customer_v2 import ReaderGroupCustomerV2


class ReaderGroupCustomerV2ListCustomerApiResponse(BaseModel):
    """
    ReaderGroupCustomerV2ListCustomerApiResponse
    """  # noqa: E501

    result: Optional[List[ReaderGroupCustomerV2]] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "result": [ReaderGroupCustomerV2.from_dict(_item) for _item in obj["result"]]

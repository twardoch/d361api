...
class UpdateReaderGroupRequestV2(BaseModel):
    ...
    description: StrictStr | None = Field(default=None, description="Description of the reader group.")
    associated_readers: list[StrictStr] | None = Field(default=None, description=" List of reader IDs to be associated with this reader group.  Note: Reader IDs that were previously associated but not present in this list during the update will be dissociated from this reader group.")
    access_scope: AddUpdateAccessScopeCustomerV2 = Field(description="Access level of this reader group.")
    associated_invited_sso_users: list[StrictStr] | None = Field(default=None, description=" List of invitation IDs to be associated with this reader group.  Note: Invitation IDs that were previously associated but not present in this list during the update will be disassociated from this reader group.")

...
class UpdateReaderGroupRequestV2(BaseModel):
    ...
    title: Annotated[str, Field(min_length=1, strict=True)] = Field(
        description="The name of the reader group."
    )
    description: Optional[StrictStr] = Field(
        default=None, description="Description of the reader group."
    )
    associated_readers: Optional[List[StrictStr]] = Field(
        default=None,
        description=" List of reader IDs to be associated with this reader group.  Note: Reader IDs that were previously associated but not present in this list during the update will be dissociated from this reader group.",
    )
    access_scope: AddUpdateAccessScopeCustomerV2 = Field(
        description="Access level of this reader group."
    )
    associated_invited_sso_users: Optional[List[StrictStr]] = Field(
        default=None,
        description=" List of invitation IDs to be associated with this reader group.  Note: Invitation IDs that were previously associated but not present in this list during the update will be disassociated from this reader group.",
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.associated_invited_sso_users is None
            and "associated_invited_sso_users" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "access_scope": AddUpdateAccessScopeCustomerV2.from_dict(obj["access_scope"])
                if obj.get("access_scope") is not None
                else None,

...
from d361api.models.api_reference_logs_data_customer import \
...
class ApiReferenceLogsWrapResponseCustomer(BaseModel):
    ...
    """
    data: list[ApiReferenceLogsDataCustomer] | None = Field(default=None, description="API reference response data")

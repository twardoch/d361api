...
class ApiReferenceLogsWrapResponseCustomer(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[ApiReferenceLogsDataCustomer]] = Field(default=None, description="API reference response data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ApiReferenceLogsDataCustomer.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,

...
class ContentRoleSummaryCustomer(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "version_access": VersionAccessInfo.from_dict(obj["version_access"])
                if obj.get("version_access") is not None
                else None,
                "language_access": LanguageAccessInfo.from_dict(obj["language_access"])
                if obj.get("language_access") is not None
                else None,
                "category_access": CategoryAccessInfo.from_dict(obj["category_access"])
                if obj.get("category_access") is not None
                else None,
                "article_access": ArticleAccessInfo.from_dict(obj["article_access"])
                if obj.get("article_access") is not None
                else None,

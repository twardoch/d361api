...
class ContentRoleSummaryCustomer(BaseModel):
    ...
    """
    version_access: VersionAccessInfo | None = None
    language_access: LanguageAccessInfo | None = None
    category_access: CategoryAccessInfo | None = None
    article_access: ArticleAccessInfo | None = None

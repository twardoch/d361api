...
class LanguageApi:
    ...
    @validate_call
    async def v2_language_project_version_id_get(
        self,
        ...
        _param = self._v2_language_project_version_id_get_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "GetLanguageFromProjectVersion",
        }
    ...
    @validate_call
    async def v2_language_project_version_id_get_with_http_info(
        self,
        project_version_id: Annotated[
            StrictStr, Field(description="The ID of the project version")
        ],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetLanguageFromProjectVersion]:
        """Gets all version languages in the project
    ...
    @validate_call
    async def v2_language_project_version_id_get_without_preload_content(
        self,
        project_version_id: Annotated[
            StrictStr, Field(description="The ID of the project version")
        ],
    ...
    def _v2_language_project_version_id_get_serialize(
        self,
        project_version_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/v2/Language/{projectVersionId}",

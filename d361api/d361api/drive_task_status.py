...
class DriveTaskStatus(BaseModel):
    ...
    DriveTaskStatus
    """
    task_id: StrictStr | None = Field(default=None, description="The task ID of the file deleted")
    is_complete: StrictBool | None = Field(default=None, description="Indicates whether the task associated with the file deletion is complete")
    status: BackgroundTaskStatus | None = Field(default=None, description="0 - Queued, 1 - Initiated, 2 - InProgress, 3 - Completed, 4 - Error, 5 - Cancelled")

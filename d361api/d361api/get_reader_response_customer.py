...
class GetReaderResponseCustomer(BaseModel):
    ...
    last_name: Optional[StrictStr] = Field(
        default=None, description="The last name of the reader."
    )
    ...
    access_scope: Optional[AccessScopeCustomerV2] = Field(
        default=None, description="The access scope of the reader."
    )
    associated_reader_groups: Optional[List[StrictStr]] = Field(
        default=None, description="An array of the group IDs the reader is associated with."
    )
    is_invite_sso_user: Optional[StrictBool] = Field(
        default=None,
    ...
    last_login_at: Optional[datetime] = Field(
        default=None, description="The last login date and time by the reader."
    )

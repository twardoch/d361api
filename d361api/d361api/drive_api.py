...
class DriveApi:
    ...
    async def v2_drive_folders_files_post(
        ...
        files: Annotated[
            ...
            Field(description="File collection -The maximum file size upload limit is 40MB"),
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    async def v2_drive_folders_folder_id_get(
        ...
        take: Annotated[
            Optional[StrictInt], Field(description="The number of results per page")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    async def v2_drive_folders_post(
        self,
        add_media_folder_request_customer: Optional[AddMediaFolderRequestCustomer] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
    ...
    async def v2_drive_search_get(
        ...
        search_keyword: Annotated[
            Optional[StrictStr], Field(description="Keyword to search file items from drive")
        ] = None,
        page_no: Annotated[
            Optional[StrictInt],
            Field(
        ...
        allow_images_only: Annotated[
            Optional[StrictBool], Field(description="Allow images only in response")
        ] = None,
        user_ids: Annotated[Optional[List[StrictStr]], Field(description="Find by userId")] = None,
        filter_from_date: Annotated[
            Optional[datetime], Field(description="Filter using from-date")
        ] = None,
        filter_to_date: Annotated[
            Optional[datetime], Field(description="Filter using to-date")
        ] = None,
        filter_tags: Annotated[
            Optional[List[StrictStr]], Field(description="Filter using tagIds")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        if filter_from_date is not None:
            if isinstance(filter_from_date, datetime):
                _query_params.append(
                    (
                        "filterFromDate",
                        filter_from_date.strftime(self.api_client.configuration.datetime_format),
                    )
                )
            else:
        ...
        if filter_to_date is not None:
            if isinstance(filter_to_date, datetime):
                _query_params.append(
                    (
                        "filterToDate",
                        filter_to_date.strftime(self.api_client.configuration.datetime_format),
                    )
                )
            else:

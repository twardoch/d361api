...
from d361api.models.all_files_with_count_customer import AllFilesWithCountCustomer
...
class AllFilesWithCountResponseCustomer(BaseModel):
    """
    AllFilesWithCountResponseCustomer
    """  # noqa: E501

    data: Optional[AllFilesWithCountCustomer] = Field(
        default=None, description="Search result meta data"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": AllFilesWithCountCustomer.from_dict(obj["data"])

...
from d361api.models.team_account_group_summary_customer import \
...
class TeamAccountGroupSummaryCustomerListCustomerApiResponse(BaseModel):
    ...
    """
    result: list[TeamAccountGroupSummaryCustomer] | None = Field(default=None, description="Customer API response data")

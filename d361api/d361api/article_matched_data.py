...
class ArticleMatchedData(BaseModel):
    ...
    ArticleMatchedData
    """
    hits: list[Hit] | None = Field(default=None, description="The list of articles that matched the search query.")
    nb_hits: StrictInt | None = Field(default=None, description="The number of hits (articles) matched by the query.")
    page: StrictInt | None = Field(default=None, description="The position of the current page (zero-based).")
    nb_pages: StrictInt | None = Field(default=None, description="The number of returned pages. Calculation is based on the total number of hits (nbHits) divided by the number of hits per page (hitsPerPage), rounded up to the nearest integer.")
    hits_per_page: StrictInt | None = Field(default=None, description="Maximum number of hits (articles) per page.")
    processing_time_ms: StrictInt | None = Field(default=None, description="The time the server took to process the request, in milliseconds. This doesn’t include network time.")
    query: StrictStr | None = Field(default=None, description="The query used to search the articles.")

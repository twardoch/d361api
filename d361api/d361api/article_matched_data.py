...
class ArticleMatchedData(BaseModel):
    ...
    hits: Optional[List[Hit]] = Field(
        default=None, description="The list of articles that matched the search query."
    )
    nb_hits: Optional[StrictInt] = Field(
        default=None, description="The number of hits (articles) matched by the query."
    )
    page: Optional[StrictInt] = Field(
        default=None, description="The position of the current page (zero-based)."
    )
    ...
    hits_per_page: Optional[StrictInt] = Field(
        default=None, description="Maximum number of hits (articles) per page."
    )
    ...
    query: Optional[StrictStr] = Field(
        default=None, description="The query used to search the articles."
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "hits": [Hit.from_dict(_item) for _item in obj["hits"]]

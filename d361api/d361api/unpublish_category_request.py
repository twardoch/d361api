...
class UnpublishCategoryRequest(BaseModel):
    """
    UnpublishCategoryRequest
    """ # noqa: E501
    user_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The ID of the team account who is responsible for the unpublish")
    ...
    version_number: Annotated[int, Field(le=32767, strict=True, ge=1)] = Field(description="The version number of the category")
    unpublish_message: Optional[StrictStr] = Field(default=None, description="Unublish message for the category")

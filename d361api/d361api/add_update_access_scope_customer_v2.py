...
class AddUpdateAccessScopeCustomerV2(BaseModel):
    ...
    access_level: AccessScopeLevel = Field(
        description="This is an enum. Possible values are  0 - None  1 - Category  2 - Version  3 - Project  4 - Lanaguage"
    )
    categories: Optional[List[CategoryScopeCustomer]] = Field(
        default=None,
        description="A list of category scope objects.  This is only required if the access level is set 1 - Category",
    )
    project_versions: Optional[List[StrictStr]] = Field(
        default=None,
        description="A list of project versions  This is only required if the access level is set to 2 - Version",
    )
    languages: Optional[List[LanguageScopeCustomer]] = Field(
        default=None,
        description="A list of language scope objects  This is only required if the access level is set to 4 - Language",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "categories": [
                    CategoryScopeCustomer.from_dict(_item) for _item in obj["categories"]
                ]
                if obj.get("categories") is not None
                else None,
                "project_versions": obj.get("project_versions"),
                "languages": [LanguageScopeCustomer.from_dict(_item) for _item in obj["languages"]]

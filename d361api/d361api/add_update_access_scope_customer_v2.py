...
class AddUpdateAccessScopeCustomerV2(BaseModel):
    ...
    categories: list[CategoryScopeCustomer] | None = Field(default=None, description="A list of category scope objects.  This is only required if the access level is set 1 - Category")
    project_versions: list[StrictStr] | None = Field(default=None, description="A list of project versions  This is only required if the access level is set to 2 - Version")
    languages: list[LanguageScopeCustomer] | None = Field(default=None, description="A list of language scope objects  This is only required if the access level is set to 4 - Language")

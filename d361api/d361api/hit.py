...
class Hit(BaseModel):
    ...
    Hit
    """
    title: StrictStr | None = Field(default=None, description="Article title")
    content: StrictStr | None = Field(default=None, description="Article HTML content")
    is_hidden: StrictBool | None = Field(default=None, description="Indicates if the article is visible on the site")
    ...
    version: StrictInt | None = Field(default=None, description="The version number that is currently published")
    ...
    is_category_hidden: StrictBool | None = Field(default=None, description="Indicates if category is visible on the site")
    order: StrictInt | None = Field(default=None, description="The position inside the parent category")
    is_draft: StrictBool | None = Field(default=None, description="Indicates if the article is marked as a draft")
    exclude: StrictBool | None = Field(default=None, description="Indicates if the article is excluded from search results on user website")
    breadcrumb: StrictStr | None = Field(default=None, description="The breadcrumb of the article")
    is_category: StrictBool | None = Field(default=None, description="If the value is True, then the object has to considered as a category, otherwise it is an article")
    attachment_ids: list[Any] | None = Field(default=None, description="The IDs of the files attached to the article")
    is_deleted: StrictBool | None = Field(default=None, description="If the value is True, then it indicates that the article has been deleted")
    is_folder_type_category: StrictBool | None = Field(default=None, description="If the value is True, then it indicates that the category is a folder type category")
    updated_on_timestamp: StrictFloat | StrictInt | None = Field(default=None, description="The last updated timestamp of the article")
    is_private: StrictBool | None = Field(default=None, description="If the value is True, then the article can only be accessed by logged in users in the knowledge base site")
    language_id: StrictStr | None = Field(default=None, description="The ID of the language")
    project_id: StrictStr | None = Field(default=None, description="The ID of the project")
    is_latest_version: StrictBool | None = Field(default=None, description="If the value is True, then the article is the latest version")
    contributors: list[StrictStr] | None = Field(default=None, description="The IDs of users who have contributed to the article")
    is_shared_article: StrictInt | None = Field(default=None, description="If the value is True, then it indicates that it is a shared article")
    lang_code: StrictStr | None = Field(default=None, description="The language code of the article or category")
    category_unique_id: StrictStr | None = Field(default=None, description="A unique identifier for the category which is a combination of category ID and the language code")
    unique_id: StrictStr | None = Field(default=None, description="A unique identifier for the article which is a combination of article ID and the language code")
    deleted_by: StrictStr | None = Field(default=None, description="The ID of the user who deleted the article")
    deleted_at: StrictStr | None = Field(default=None, description="The timestamp when the article was deleted")
    is_git_hub_entity: StrictBool | None = Field(default=None, description="If the value is True, then it indicates that the article is synced from GitHub")
    original_article_id: StrictStr | None = Field(default=None, description="The original article ID. Applicable only for shared articles.")
    object_id: StrictStr | None = Field(default=None, description="algolia search object ID")
    snippet_result: Snippetresult | None = Field(default=None, description="Markup text with occurrences highlighted.", alias="_snippet_result")
    highlight_result: Highlightresult | None = Field(default=None, description="Highlighted attributes", alias="_highlight_result")

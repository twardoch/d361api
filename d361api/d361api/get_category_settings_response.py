...
class GetCategorySettingsResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[CategorySettingsCustomer] = Field(default=None, description="This is to get category settings data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CategorySettingsCustomer.from_dict(obj["data"]) if obj.get("data") is not None else None,

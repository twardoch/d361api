...
class GetCategoryContentResponse(BaseModel):
    ...
    """ # noqa: E501
    category: Optional[CategoryVersionData] = Field(default=None, description="Get category version data")
    ...
    __properties: ClassVar[List[str]] = ["category", "extension_data", "success", "errors", "warnings", "information"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "category": CategoryVersionData.from_dict(obj["category"]) if obj.get("category") is not None else None,

...
from d361api.models.category_version_data import CategoryVersionData


class GetCategoryContentResponse(BaseModel):
    """
    GetCategoryContentResponse
    """  # noqa: E501

    category: Optional[CategoryVersionData] = Field(
        default=None, description="Get category version data"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "category": CategoryVersionData.from_dict(obj["category"])

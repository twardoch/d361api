...
class ExportDocumentationResponse(BaseModel):
    ...
    """
    id: StrictStr | None = Field(default=None, description="The ID of the export request. Use this ID to get export details")
    status: StrictStr | None = Field(default=None, description="Current status of the export")

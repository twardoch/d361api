...
class ExportDocumentationResponse(BaseModel):
    """
    ExportDocumentationResponse
    """  # noqa: E501

    id: Optional[StrictStr] = Field(
        default=None, description="The ID of the export request. Use this ID to get export details"
    )
    status: Optional[StrictStr] = Field(default=None, description="Current status of the export")

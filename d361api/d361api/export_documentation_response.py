...
class ExportDocumentationResponse(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID of the export request. Use this ID to get export details")
    ...
    __properties: ClassVar[List[str]] = ["id", "status", "extension_data", "success", "errors", "warnings", "information"]

...
class MediaFolderViewMetaDataCustomer(BaseModel):
    ...
    files: Optional[List[MediaFilesMetaDataCustomer]] = Field(
        default=None, description="The files associated to the folder"
    )
    icon: Optional[StrictStr] = Field(default=None, description="The icon of the folder")
    items_count: Optional[StrictInt] = Field(
        default=None, description="Subfolder count in the folder"
    )
    updated_on: Optional[datetime] = Field(
        default=None, description="The date the folder was created"
    )
    updated_by: Optional[StrictStr] = Field(
        default=None, description="The ID of the user that created the folder"
    )
    is_starred: Optional[StrictBool] = Field(
        default=None, description="This denotes the folder is starred or not"
    )
    ...
    sub_folders: Optional[List[MediaFoldersDataCustomer]] = Field(
        default=None, description="Sub folders of the media folder"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "files": [MediaFilesMetaDataCustomer.from_dict(_item) for _item in obj["files"]]
                ...
                "sub_folders": [
                    MediaFoldersDataCustomer.from_dict(_item) for _item in obj["sub_folders"]
                ]
                if obj.get("sub_folders") is not None
                else None,
            }
        )
        return _obj

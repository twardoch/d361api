...
class GuideAccessInfo(BaseModel):
    """
    GuideAccessInfo
    """ # noqa: E501
    guide_name: Optional[StrictStr] = None
    category_name: Optional[StrictStr] = None
    category_id: Optional[StrictStr] = None
    language_id: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["guide_name", "category_name", "category_id", "language_id", "language_name", "language_code", "version_name", "version_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if guide_name (nullable) is None
        # and model_fields_set contains the field
        if self.guide_name is None and "guide_name" in self.model_fields_set:
            _dict['guide_name'] = None

...
class DateRange(BaseModel):
    ...
    after: Optional[datetime] = Field(
        default=None, description="Filter the articles which are all modified after the given date"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"after": obj.get("after"), "before": obj.get("before")})
        return _obj

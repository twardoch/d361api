...
class DateRange(BaseModel):
    ...
    DateRange
    """ # noqa: E501
    after: Optional[datetime] = Field(default=None, description="Filter the articles which are all modified after the given date")
    before: Optional[datetime] = Field(default=None, description="Filter the articles which are all modified before the given date")

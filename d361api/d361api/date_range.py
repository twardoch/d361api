...
class DateRange(BaseModel):
    ...
    DateRange
    """
    after: datetime | None = Field(default=None, description="Filter the articles which are all modified after the given date")
    before: datetime | None = Field(default=None, description="Filter the articles which are all modified before the given date")

...
from d361api.models.api_definition_inforamtion_customer import ApiDefinitionInforamtionCustomer
...
class GetApiReferenceDataResponseCustomer(BaseModel):
    """
    GetApiReferenceDataResponseCustomer
    """  # noqa: E501

    data: Optional[List[ApiDefinitionInforamtionCustomer]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": [
                    ApiDefinitionInforamtionCustomer.from_dict(_item) for _item in obj["data"]
                ]

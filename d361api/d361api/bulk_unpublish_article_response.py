...
from d361api.models.bulk_article_result_customer import BulkArticleResultCustomer


class BulkUnpublishArticleResponse(BaseModel):
    """
    BulkUnpublishArticleResponse
    """  # noqa: E501

    data: Optional[List[BulkArticleResultCustomer]] = Field(
        default=None, description="Bulk unpublish article response data"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": [BulkArticleResultCustomer.from_dict(_item) for _item in obj["data"]]

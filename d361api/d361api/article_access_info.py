...
class ArticleAccessInfo(BaseModel):
    """
    ArticleAccessInfo
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["article_name", "category_name", "category_id", "language_id", "language_name", "language_code", "version_name", "version_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "article_name": obj.get("article_name"),

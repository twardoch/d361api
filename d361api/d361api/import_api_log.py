...
class ImportAPILog(BaseModel):
    ...
    ImportAPILog
    """ # noqa: E501
    new_versions: Optional[StrictInt] = Field(default=None, description="The number of versions imported")
    categories: Optional[StrictInt] = Field(default=None, description="The number of categories imported")
    articles: Optional[StrictInt] = Field(default=None, description="The number of articles imported")
    languages: Optional[StrictStr] = Field(default=None, description="The number of languages imported")

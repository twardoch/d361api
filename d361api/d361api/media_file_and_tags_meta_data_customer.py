...
class MediaFileAndTagsMetaDataCustomer(BaseModel):
    ...
    updated_on: Optional[datetime] = Field(
        default=None, description="The date the file was uploaded"
    )
    updated_by: Optional[StrictStr] = Field(
        default=None, description="The ID of user who uploaded the file"
    )
    ...
    alternative_text: Optional[StrictStr] = Field(
        default=None, description="The file alternative text"
    )
    tags: Optional[List[TagsMetaDataCustomer]] = Field(
        default=None, description="The tags associated with the file"
    )
    thumbnail_url: Optional[StrictStr] = Field(default=None, description="The thumbnail URL")
    is_starred: Optional[StrictBool] = Field(
        default=None, description="This denotes the file is starred or not"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "tags": [TagsMetaDataCustomer.from_dict(_item) for _item in obj["tags"]]

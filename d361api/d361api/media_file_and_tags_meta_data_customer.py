...
class MediaFileAndTagsMetaDataCustomer(BaseModel):
    ...
    alternative_text: StrictStr | None = Field(default=None, description="The file alternative text")
    tags: list[TagsMetaDataCustomer] | None = Field(default=None, description="The tags associated with the file")
    thumbnail_url: StrictStr | None = Field(default=None, description="The thumbnail URL")

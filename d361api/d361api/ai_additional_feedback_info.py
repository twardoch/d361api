...
class AIAdditionalFeedbackInfo(BaseModel):
    ...
    need_more_information: Optional[StrictBool] = Field(
        default=None,
        description="User needs more information than what was provided in the AI response.",
    )
    difficult_to_understand: Optional[StrictBool] = Field(
        default=None, description="The AI response was difficult for the user to understand."
    )
    irrelevant_content: Optional[StrictBool] = Field(
        default=None, description="The AI response was not relevant to the user's query."
    )
    incorrect_source_reference: Optional[StrictBool] = Field(
        default=None,
        description="The source references in the AI response were incorrect or misleading.",
    )
    missing_information: Optional[StrictBool] = Field(
        default=None, description="Important information was missing from the AI response."
    )
    dont_like_style: Optional[StrictBool] = Field(
        default=None, description="The user did not like the style of the AI response."
    )
    others: Optional[StrictBool] = Field(
        default=None,
        description="The user's feedback does not fall under the predefined categories.",
    )
    comments: Optional[StrictBool] = Field(
        default=None, description="Indicates whether the user has provided additional comments."
    )

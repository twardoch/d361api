...
from d361api.models.project_version_customer import ProjectVersionCustomer
...
class GetProjectVersionsResponse(BaseModel):
    ...
    data: Optional[List[ProjectVersionCustomer]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": [ProjectVersionCustomer.from_dict(_item) for _item in obj["data"]]

...
class UpdateCategoryContentRequest(BaseModel):
    ...
    category_id: Optional[StrictStr] = Field(
        default=None, description="Category ID for updating the content"
    )
    lang_code: Optional[StrictStr] = Field(
        default=None, description="Language Code for updating the content"
    )
    ...
    translation_option: Optional[StrictStr] = Field(
        default=None,
        description="Translation status of the category. 0 - None, 1 - Needs translation, 2 Translated",
    )
    source: Optional[StrictStr] = Field(
        default=None, description="Free text used for future reference"
    )
    updated_by: Optional[StrictStr] = Field(
        default=None, description="The ID of the team account responsible for the category update"
    )

...
class GetCustomerTaskStatusResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["task_status", "extension_data", "success", "errors", "warnings", "information"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "task_status": DriveTaskStatus.from_dict(obj["task_status"]) if obj.get("task_status") is not None else None,

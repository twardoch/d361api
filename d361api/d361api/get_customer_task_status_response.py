...
from d361api.models.drive_task_status import DriveTaskStatus


class GetCustomerTaskStatusResponse(BaseModel):
    """
    GetCustomerTaskStatusResponse
    """  # noqa: E501

    task_status: Optional[DriveTaskStatus] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.task_status:
            _dict["task_status"] = self.task_status.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "task_status": DriveTaskStatus.from_dict(obj["task_status"])
                if obj.get("task_status") is not None
                else None,

...
class BulkUnpublishCategoryRequest(BaseModel):
    ...
    categories: List[BulkUnpublishCategory] = Field(
        description="Details of the categories need to be unpublished"
    )
    user_id: Annotated[str, Field(min_length=1, strict=True)] = Field(
        description="The ID of the team account that will be marked as the contributor of this unpublish"
    )
    project_version_id: Annotated[str, Field(min_length=1, strict=True)] = Field(
        description="The project version ID where the category exists."
    )
    unpublish_message: Optional[StrictStr] = Field(
        default=None, description="The unpublish message of the category"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "categories": [
                    BulkUnpublishCategory.from_dict(_item) for _item in obj["categories"]
                ]

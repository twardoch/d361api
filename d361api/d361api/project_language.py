...
class ProjectLanguage(BaseModel):
    ...
    language_code: Optional[StrictStr] = Field(
        default=None, description="The code of the language"
    )
    language_name: Optional[StrictStr] = Field(
        default=None, description="The name of the language"
    )
    is_set_as_default: Optional[StrictBool] = Field(
        default=None,
        description="`True` - Default language of the version; `False` - Non-default language of the version",
    )
    country_flag_code: Optional[StrictStr] = Field(
        default=None, description="The code of the country flag"
    )

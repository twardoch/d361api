...
class ProjectLanguage(BaseModel):
    ...
    language_code: StrictStr | None = Field(default=None, description="The code of the language")
    language_name: StrictStr | None = Field(default=None, description="The name of the language")
    is_set_as_default: StrictBool | None = Field(default=None, description="`True` - Default language of the version; `False` - Non-default language of the version")
    country_flag_code: StrictStr | None = Field(default=None, description="The code of the country flag")

...
class EmailExistsResponse(BaseModel):
    ...
    EmailExistsResponse
    """ # noqa: E501
    data: Optional[EmailExists] = Field(default=None, description="Response that checks if the given email address exists in the project")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": EmailExists.from_dict(obj["data"]) if obj.get("data") is not None else None,

...
class GetArticleSettingsResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[ArticleSettingCustomer] = Field(default=None, description="Get article settings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ArticleSettingCustomer.from_dict(obj["data"]) if obj.get("data") is not None else None,

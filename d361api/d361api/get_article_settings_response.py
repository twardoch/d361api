...
from d361api.models.article_setting_customer import ArticleSettingCustomer
...
class GetArticleSettingsResponse(BaseModel):
    """
    GetArticleSettingsResponse
    """  # noqa: E501

    data: Optional[ArticleSettingCustomer] = Field(
        default=None, description="Get article settings"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": ArticleSettingCustomer.from_dict(obj["data"])

...
class ImportDocumentationResponse(BaseModel):
    ...
    """
    id: StrictStr | None = Field(default=None, description="The ID of the import request. Use this ID to get the import details")
    status: StrictStr | None = Field(default=None, description="Current status of the import")
